    ...
    private var content: some View {
        if session.endpoint == nil {
            ...
            List {
                ...
                // Recent conversation is the most actionable part of
                // the dashboard: operators want to see what the robot
                // heard and replied before checking telemetry or
                // connection health. Put it at the top.
